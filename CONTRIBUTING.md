...
- Submit an issue on the [Issues
  page](https://github.com/ropensci/wikitaxa/issues)
...
- Clone your version on your account down to your machine from your
  account, e.g,.
  `git clone https://github.com/<yourgithubusername>/wikitaxa.git`
- Make sure to track progress upstream (i.e., on our version of
  `wikitaxa` at `ropensci/wikitaxa`) by doing
  `git remote add upstream https://github.com/ropensci/wikitaxa.git`.
...
- Make your changes (bonus points for making changes on a new feature
  branch)
